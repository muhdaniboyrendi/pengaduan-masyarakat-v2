            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 ml-3 text-light">Registrasi</h3>
                        <form action="" method="POST">
                            <div class="col-lg-12">
                                <div class="card o-hidden border-0 p-4 shadow-lg my-5 bg-dark text-light">
                                    <div class="mb-3">
                                        <input type="text" class="form-control bg-dark text-light" id="nama_petugas" name="nama_petugas" placeholder="Nama Lengkap" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <input type="password" class="form-control bg-dark text-light" name="password2" placeholder="Konfirmasi Password" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control bg-dark text-light" id="telp" name="telp" placeholder="Telepone" required>
                                    </div>
                                    <div class="mb-3">
                                        <select class="form-select bg-dark text-light" name="level" required>
                                            <option value="">Level</option>
                                            <option value="admin">Admin</option>
                                            <option value="petugas">Petugas</option>
                                        </select>
                                    </div>
                                    <button type="submit" name="register" class="btn btn-outline-primary mt-3">Daftar</button>
                                </div>
                            </div>
                        </form>
                    </div>
