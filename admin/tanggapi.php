...
if(isset($_POST["tanggapi"])){
    if(tanggapan($_POST) > 0){
        echo "<script>alert('Laporan verhasil ditanggapi');</script>";
        header("locaton: tanggapan.php");
        exit;
    }else{
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 ml-3 text-light">Tanggapi</h3>
                        <div class="col-lg-12">
                            <form action="" method="POST">
                                <div class="card o-hidden mt-0 border-0 p-4 shadow-lg my-5 bg-dark text-light">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label text-light">Tanggapan</label>
                                        <textarea class="form-control bg-dark text-light" name="tanggapan" id="tanggapan" rows="4" placeholder="Tulis tanggapan" required></textarea>
                                    </div>
                                    <hr class="sidebar-divider mt-0 text-gray-600">
                                    <button class="btn btn-outline-success" name="tanggapi" value="<?= $id_pengaduan; ?>">Tanggapi</button>
                                    <a class="btn btn-outline-danger mt-2" href="tanggapan-lengkap.php?id_pengaduan=<?= $id_pengaduan; ?>">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>
