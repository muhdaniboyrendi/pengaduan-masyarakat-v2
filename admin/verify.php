...
if(isset($_POST["verify"])){
    if(verifikasi($_POST) > 0){
        ...
        echo "<script>alert('Laporan gagal diverifikasi');</script>";
    }
}
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 ml-3 text-light">Verifikasi dan Validasi</h3>
                        <div class="col-lg-12">
                            ...
                            <?php foreach($pengaduan as $item): ?>
                                ...
                                <form action="" method="POST">
                                    <button class="btn btn-outline-success col-lg-12" name="verify" value="<?= $id_pengaduan; ?>">Verifikasi</button>
                                </form>
                                <a class="btn btn-outline-danger mt-2" href="verifikasi.php">Kembali</a>
                            <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
