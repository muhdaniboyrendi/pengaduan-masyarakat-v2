            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 text-light">Pengaduan Masyarakat</h3>
                        <div class="row">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <div class="card bg-dark">
                                    <div class="card-body">
                                        <h5 class="card-title text-white"><i class="fas fa-fw fa-clipboard-list"></i> Laporan</h5>
                                        <p class="card-text text-gray-500">Membuat laporan seluruh pengaduan dari masyarakat</p>
                                        <a href="laporan.php" class="btn btn-outline-primary">Generate Laporan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <h4 class="h4 mb-4 mt-4 text-light">User</h4>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card bg-dark">
                                    <div class="card-body">
                            ...
                            <div class="col-sm-4">
                                <div class="card bg-dark">
                                    <div class="card-body">
                                        <h5 class="card-title text-white"><i class="fas fa-fw fa-users-cog"></i> Registrasi</h5>
                                        <p class="card-text text-gray-500">Mambuat akun petugas</p>
