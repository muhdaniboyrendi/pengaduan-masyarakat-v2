...
<html lang="en">
    <head>
        ...
        <title>Laporan Selesai | Selengkapnya</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 ml-3 text-light">Laporan Selesai</h3>
                        <div class="col-lg-12">
                            ...
                            <?php foreach($pengaduan as $item): ?>
                                ...
                                <hr class="sidebar-divider mt-0 text-gray-600">
                                <div>
                                    <label class="form-label text-light">Tanggapan</label>
                                    <p class="text-gray-500"><?= $item["tanggapan"]; ?></p>
                                </div>
                                <hr class="sidebar-divider mt-0 text-gray-600">
                                <div>
                                    <label class="form-label text-light">Tanggal Tanggapan</label>
                                    <p class="text-gray-500"><?= $item["tgl_tanggapan"]; ?></p>
                                </div>
                                <hr class="sidebar-divider mt-0 text-gray-600">
                                <div>
                                    <label class="form-label text-light">Petugas</label>
                                ...
                                <hr class="sidebar-divider mt-0 text-gray-600">
                                <a class="btn btn-outline-danger mt-2" href="laporan-selesai.php">Kembali</a>
                            <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
