            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900 pb-5">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 text-light">Laporan Selesai</h3>
                        <div class="card shadow mb-2 bg-dark">
                                    ...
                                    <table class="table table-dark table-hover">
                                        ...
                                        <?php foreach($pengaduan as $item): ?>
                                            <tr>
                                                ...
                                                <td><?= $item["status"]; ?></td>
                                                <td>
                                                    <a class="badge btn-primary" href="lihat-selesai.php?id_pengaduan=<?= $item["id_pengaduan"]; ?>">Selengkapnya</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
