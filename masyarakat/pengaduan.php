...
if(isset($_POST["kirim"])){
    if(pengaduan($_POST) > 0){
        echo "<script>alert('Laporan anda berhasil dikirim');</script>";
    }else{
        echo "<script>alert('Laporan anda gagal dikirim');</script>";
    }
}
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content" class="bg-gray-900">
                    ...
                    <div class="container-fluid">
                        <h3 class="h3 mb-4 ml-3 text-light">Tulis Pengaduan</h3>
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="col-lg-12">
                                <div class="card o-hidden border-0 p-4 shadow-lg my-5 bg-dark text-light">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label text-light">Laporan</label>
                                        <textarea class="form-control bg-dark text-light" name="isi_laporan" id="isi_laporan" rows="4" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label text-light">Foto</label>
                                        <input class="form-control bg-dark text-light" type="file" name="foto" id="foto" required>
                                    </div>
                                    <button class="btn btn-outline-success mt-2" type="submit" name="kirim">Kirim</button>
                                </div>
                            </div>
                        </form>
                    </div>
